<?php
// Heading
$_['heading_title']      = 'Payer E-faktura';

// Text
$_['text_payment']       = 'Betalning';
$_['text_success']       = 'Du har nu uppdaterat kontouppgifterna!';
$_['text_edit']          = 'Ändrat Payer E-faktura';
$_['text_development']   = '<span style="color: green;">Ready</span>';
$_['text_payer_einvoice'] = '<a onclick="window.open(\'http://payer.se\');"><img src="view/image/payment/payer.png" alt="Payer" title="Payer" /><br/></a>';
...
// Error
$_['error_permission']   = 'Varning: Du har inte tillåtelse att ändra i denna betalmodul!';
$_['error_mid']          = 'Agent ID krävs!';
$_['error_key']          = 'Key A krävs';
$_['error_keyb']         = 'Key B krävs!';
?>